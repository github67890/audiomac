...
function Verify() {
    ...
    const submitverify =  async() => {
        ////  alert('ddddddddddddd')
          ...
          const response= await fetch(myModule.servername+"/api/users/requestverify", {
            method: "post",
            headers: {
              "content-type": "application/x-www-form-urlencoded; charset=utf-8",
            },
            body: `postedid=${localStorage.getItem('token')}&description=${description}&username=${localStorage.getItem('registername')}`,
          });
                ...
                <Col md="9" lg="9" sm="10" xs="10">
                    ...
                    <Row>
                        ...
                        <Col md="4" lg="4" sm="7" xs="7">
                            <Button    onClick={submitverify}  className="btn-round" color="info" type="button"  >
