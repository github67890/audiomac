...
const getallsinglesongdata = async()  => {
  ...
  var myModule = require('views/database');
const response= await fetch(myModule.servername+"/api/users/sidebarplaylist", {
  method: "post",
  headers: {
...
<span class="icon-music-album podiconland"></span>
  <span className="tran">&nbsp;&nbsp;&nbsp;Playlist</span>
</Col>
...
{/* {test.map((s,i)=> ( <>hahahahh</>))} */}
 ...
 <h3 className="singer-name">{alldata[0].playlistname.substring(0, 12)}</h3>   
