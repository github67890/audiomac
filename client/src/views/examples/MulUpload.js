   ...
   const [modal2, setModal2] = React.useState(false);
    ...
    const firstpage = (e) => {
      ...
      seterrorsongmp3("unvalid");
          ...
          const secondpage = (e) => {
            if(artistname!="" && album!="" &&songpic!="" && genre!=""){
              setPills("3");
...
//  }
    ...
    const getalldata =  async() => {
      ...
      var songtype   = parts[parts.length - 1];
    ...
    ///  data.append("file", selectedFile);
      if(filesize=='1'){
        ...
        let res = await axios
        .post(myModule.servername + "/api/users/multiplefiles", data, {
...
<Col md="4" lg="4" sm="7" xs="7">
      <Button className="btn-round" color="info" type="file" onClick={firstpage}>
...
<Button className="btn-round" color="danger" type="file" onClick={e => {
                          e.preventDefault();
                          setPills("1");
                        }}>
