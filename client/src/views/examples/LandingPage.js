...
{genretest=="all" ? <>{alldata.slice(0, 4).map((s,i)=> ( <>
{/* {i!==4 ?<>ff</>:null} */}
...
))}</>:<>{alldata.filter(book => book.genre ===genretest).slice(0, 4).map((s,i)=> ( <>
  {/* {i!==4 ?<>ff</>:null} */}
...
<span class="icon-album mixiconland"></span>
<span className="tran">&nbsp;&nbsp;&nbsp;Mixtape</span>
<br></br><br></br>
...
{/* {test.map((s,i)=> ( <>hahahahh</>))} */}
 ...
 {alldata.filter(book => book.songtype === "mixtape").slice(0, 4).map((s,i)=> ( <>
{/* {s.!==4 ?<>ff</>:null} */}
...
<span class="icon-podcast podiconland"></span>
<span className="tran">&nbsp;&nbsp;&nbsp;Podcast</span>
<br></br><br></br>
...
{/* {test.map((s,i)=> ( <>hahahahh</>))} */}
 ...
 {alldata.filter(book => book.songtype === "poadcast").slice(0, 4).map((s,i)=> ( <>
{/* {s.!==4 ?<>ff</>:null} */}
...
<span class="icon-carnival-mask podiconland"></span>
<span className="tran">&nbsp;&nbsp;&nbsp;Carvinal</span>
<br></br><br></br>
...
{/* {test.map((s,i)=> ( <>hahahahh</>))} */}
 ...
 {alldata.filter(book => book.genre === "Carnival").slice(0, 4).map((s,i)=> ( <>
{/* {s.!==4 ?<>ff</>:null} */}
